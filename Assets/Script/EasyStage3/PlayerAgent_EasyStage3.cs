...
public class PlayerAgent_EasyStage3 : Agent
{
    // Start is called once before the first execution of Update after the MonoBehaviour is created
    Rigidbody2D m_RigidBody;
    Transform m_Transform;
    StageManager_EasyStage3 StageManager;
    ...
    public override void Initialize()
    {
        ...
        StageManager = GameObject.Find("StageManager").GetComponent<StageManager_EasyStage3>();
    }
    public void Start()
    {
