...
public class PlayerAgent_EasyStage1 : Agent
{
    // Start is called once before the first execution of Update after the MonoBehaviour is created
    Rigidbody2D m_RigidBody;
    Transform m_Transform;
    StageManager_EasyStage1 StageManager;
    ...
    public override void Initialize()
    {
        ...
        StageManager = GameObject.Find("StageManager").GetComponent<StageManager_EasyStage1>();
    }
    public void Start()
    {
